...
# IMPORTANT: when using the logit (sigmoid) transfer function for the output 
# layer make sure y values are scaled from 0 to 1
...
class MLP_NeuralNetwork(object):
    """
    Basic MultiLayer Perceptron (MLP) network, adapted and from the book
...
def demo():
    ...
    NN = MLP_NeuralNetwork(64, 100, 10, iterations = 5, learning_rate = 0.5, momentum = 0.5, rate_decay = 0.01)
