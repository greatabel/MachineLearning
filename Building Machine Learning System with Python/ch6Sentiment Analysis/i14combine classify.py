...
from i4utils import load_sent_word_net, log_false_positives
...
if __name__ == "__main__":
    ...
    train_model(get_best_model(), X, Y, name="sent vs rest", plot=True)
    ...
    # 0.781   0.060   0.875   0.066   
    # == Pos vs. rest ==
    # 0.631   0.039   0.692   0.077   
    # == Neg vs. rest ==
    # 0.743   0.035   0.559   0.069