...
from i1twitterauth import CONSUMER_KEY, CONSUMER_SECRET, ACCESS_TOKEN_KEY, ACCESS_TOKEN_SECRET
...
def read_total_list(in_filename):
    ...
    print("We will skip %i tweets that are not available/visible any more on twitter" % \
